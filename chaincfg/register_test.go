	...
	tests := []struct {
	...
	}{
		{
			...
			p2pkhMagics: []magicTest{
				...
				{
					magic: TestNet5Params.PubKeyHashAddrID,
					valid: true,
				},
				{
			...
			p2shMagics: []magicTest{
				...
				{
					magic: TestNet5Params.ScriptHashAddrID,
					valid: true,
				},
				{
			...
			segwitPrefixes: []prefixTest{
				...
				{
					prefix: TestNet5Params.Bech32HRPSegwit + "1",
					valid:  true,
				},
				{
			...
			hdMagics: []hdTest{
				...
				{
					priv: TestNet5Params.HDPrivateKeyID[:],
					want: TestNet5Params.HDPublicKeyID[:],
					err:  nil,
				},
				{
