...
type config struct {
	...
	TestNet5       bool   `long:"testnet" description:"Use the test network"`
...
// time of writing, btcd currently places blocks for testnet version 5 in the
// data and log directory "testnet", which does not match the Name field of the
// chaincfg parameters.  This function can be used to override this directory name
// as "testnet" when the passed active network matches wire.TestNet5.
//
// A proper upgrade to move the data and log directories for this network to
// "testnet5" is planned for the future, at which point this function can be
...
func loadConfig() (*config, []string, error) {
	...
	if cfg.TestNet5 {
		numNets++
		activeNetParams = &chaincfg.TestNet5Params
	}
