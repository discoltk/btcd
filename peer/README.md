...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/discoltk/btcd/peer)
...
```bash
$ go get -u github.com/discoltk/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/discoltk/btcd/peer#example-package--NewOutboundPeer)  
