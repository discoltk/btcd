...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/discoltk/btcd/mining/cpuminer)
...
```bash
$ go get -u github.com/discoltk/btcd/mining/cpuminer
```
